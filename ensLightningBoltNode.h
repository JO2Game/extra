...
public:
    ...
    static ClightningBoltSprite* create(const string&texFileName);
    static ClightningBoltSprite* createWithSpriteFrameName(const string&texFileName);
...
public:
    ...
    static ClightningBoltNode* create(const string&texFileName,const CCPoint&start,const CCPoint&end);
    static ClightningBoltNode* createWithSpriteFrameName(const string&texFileName,const CCPoint&start,const CCPoint&end);
    bool initWithFile(const string&texFileName,const CCPoint&start,const CCPoint&end);
    bool initWithSpriteFrameName(const string&texFileName,const CCPoint&start,const CCPoint&end);
    bool initWithBoltSprite(ClightningBoltSprite* sprite1, ClightningBoltSprite* sprite2, const CCPoint&start,const CCPoint&end);
    ...
    void runFlashAction(float flashTime=0.7f);
protected:
